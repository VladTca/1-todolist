...
function App() {
    ...
    const removeAllTodolists = () => {
        setTodo([
            {title: "What to learn", filter: "all", tasks: [], students: []},
            {title: "What to buy", filter: "all", tasks: [], students: []}
        ])
    }
    ...
    return (
        <div className="App">
            <div>
                <Button title={'Remove allTodolists'} onClickhandler={removeAllTodolists} />
            </div>
